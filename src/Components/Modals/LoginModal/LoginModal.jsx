...
export default function LoginModal() {
  ...
  const handleSubmit = async(e) => {
    ...
    try {
      const res= await axios.get(`/api/User/CheckUserExists?nationalCode=${nCode}&captchaId=${captchaid}captchaValue=${captchaValue}`)
  ...
  return (
    <>
      ...
      {/* فرم‌ها */}
      {activeTab === "national" && (
        <form onSubmit={handleSubmit} className="space-y-12 h-1/2 flex flex-col justify-between sm:w-5/6 w-8/9">
