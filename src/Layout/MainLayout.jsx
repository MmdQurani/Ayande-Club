    ...
    <div className='MainLayout pb-15 lg:pb-0 w-full h-max min-h-screen bg-main-1 flex lg:flex-row flex-col justify-start lg:justify-center relative' dir='rtl'>
      ...
      {isIPad ?
        <div className='main_menu_mobile fixed bottom-4 left-0 right-0 mx-auto w-[90%] h-[75px] flex flex-row items-center justify-around rounded-2xl bg-gradient-to-r from-secondary-8 to-secondary-7 z-[150]'>
          ...
          <NavLink to={'/services'} className={({ isActive }) => `flex flex-row space-x-2 items-center text-white ${isActive ? 'border-b-2 border-white stroke-white pb-2.5 fill-white' : 'border-b-2 border-transparent stroke-white'}`}>
            <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" fill="none">
      ...
      <div className='lg:container h-full w-full px-2 sm:px-12 lg:px-2 flex flex-row justify-center my-0 mt-12 lg:mt-10 mb-12 space-x-4'>
