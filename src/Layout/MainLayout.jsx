...
function MainLayout({ children }) {
  ...
  return (
    <div className='MainLayout w-full min-h-screen bg-gray-100/60 flex lg:flex-row flex-col justify-center relative' dir='rtl'>
      ...
      <div className='lg:container w-full px-2 flex flex-row justify-center my-0 lg:my-10 space-x-4'>
        ...
        <main className='main flex-1 min-w-0 relative z-0'>
          <MainHeader />
          {children}
        </main>
      </div>
