export const main_menu = [
  ...
  },
  {
    ...
    title: "نردبان رشد",
    children: [
      { href: "/growth/points-guide", title: "راهنمای امتیازات" },
      { href: "/growth/earn-points", title: "شرح کسب امتیاز" },
      { href: "/growth/club-rules", title: "قوانین باشگاه کوانتوم" },
    ],
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
  ...
  },
  {
    ...
    title: "حساب کاربری",
    children: [
      { href: "/profile/info", title: "اطلاعات کاربری" },
      { href: "/profile/logs", title: "گزارش ورود و خروج" },
      { href: "/profile/change-password", title: "تغییر رمز" },
    ],
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
